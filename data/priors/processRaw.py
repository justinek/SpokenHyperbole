...
relevant_fields = ["workerid", "Answer.gender", "Answer.age", "Answer.income", "Answer.nativeLanguage", "Answer.orders", "Answer.items", "Answer.itemTypes", "Answer.buyers", "Answer.buyerTypes", "Answer.prices", "Answer.comments"]
relevant_indices = []
